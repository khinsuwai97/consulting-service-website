    ...
    <section id="form" className="md:py-[90px] py-14">
      ...
      >
        <motion.div
          ...
          className="w-full bg-black-gradient-2 box-shadow md:flex-row flex-col flex justify-between rounded-[30px] py-[40px] px-[65px]  "
        >
          <div className="flex flex-col flex-1">
            ...
            <p
              className={`${styles.paragraph} max-w-[500px] mt-5 md:mb-0 mb-5`}
            >
